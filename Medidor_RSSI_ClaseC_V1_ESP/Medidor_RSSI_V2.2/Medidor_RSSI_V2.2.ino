...
#define VERSION "Medidor RSSI             V2.2 ESP"       //Version
...
//  display.clearDisplay();
  ...
  Serial.print("devAddr: "); Serial.println(devAddr);
    ...
    //while(rssiValue <= -157) {    //cada 3 seg envio uncero para obtener una respuesta
...
void loop() {
  Serial.print("dato entrante: ");Serial.println(datoEntrante);
  Serial.print("rssiSend: ");Serial.println(rssiSend);

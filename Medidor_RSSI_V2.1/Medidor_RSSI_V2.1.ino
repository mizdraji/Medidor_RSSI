...
//ABP Credentials 
const char *devAddr = "ef491cef";       //"ef491cef": 24337; 
...
const unsigned long interval = 4000;    // 5 s interval to send message
unsigned long previousMillis = 0;  // will store last time message sent
unsigned int counter = 0;     // message counter

int rssiValue=0;
char rssiSend[20]={0};
char datoEntrante[20]={0};
...
//
//while(lora.getRssi()<=-155) {    //cada cierto invervalo envio uncero
//     
//lora.sendUplink(uncero, strlen(uncero), 0, 1);      // no funciona corregir
